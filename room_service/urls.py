...
urlpatterns = [
    ...
    path('room_service/', HomeView.as_view(), name='room_service'),
...
from django.urls import path
from .views import (HomeView, BathListView, CategoryListView, FoodDetailView, 
                    BathDetailView, BedDetailView, ETCDetailView, CartView, 
                    AddToCartView, DeleteSelectedView, DeleteSelectedItemsView)
from . import views
